...
export class MainPageComponent implements OnInit {
  ...
  getMatches() {
    ...
    fetch("https://api-football-v1.p.rapidapi.com/v3/fixtures?date="+ this.day , {
      "method": "GET",
      "headers": {
      ...
      .then(result => {
        ...
        rMatches["response"].forEach( (e) => {
          this.matches.push({idFixture : e["fixture"]["id"], dateTime : new Date(e["fixture"]["date"]), shortStatus : e["fixture"]["status"]["short"],
